<?php
    $sql = "SELECT judul_berita, tanggal_berita, isi_berita, nama FROM berita INNER JOIN anggota ON berita.penulis = anggota.nim";
    $berita = mysqli_query($koneksi, $sql);
?>
<div class="container-xxl position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="index.php?include=berita" class="nav-item nav-link active">Berita</a>
        ...
        <div class="container-xxl py-5">
            <div class="container py-5 px-lg-5">
                <div class="row g-4">
                    <?php while($data = mysqli_fetch_row($berita)) { ?>
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="feature-item bg-light rounded text-center p-4">
                                <i class="fa fa-3x fa-mail-bulk text-primary mb-4"></i>
                                <h5 class="mb-3"><?php echo $data[0] ?></h5>
                                <h6 class="mb-3"><?php echo $data[3] ?></h6>
                                <p><?php echo $data[1] ?>, </p>
                                <?php print $data[2] ?>
                            </div>
                        </div>
